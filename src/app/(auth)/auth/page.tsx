        ...
        <div className="w-full flex flex-col items-center justify-center gap-4 pointer-events-auto">
          <div className="text-center space-y-2 mb-3">
            <h1 className="text-2xl font-semibold tracking-tight">
              Welcome to <span className="text-gray-400">FuseIon</span>
            </h1>
          </div>

          <div className="w-full max-w-sm">
            <form action={loginAction}>
              <Button className="w-full text-white font-semibold text-lg py-6 px-4 rounded-lg h-14 transition-colors">
                <svg
